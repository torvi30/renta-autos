...
const DICTIONARY: Record<LanguageCode, Translations> = {
  ES: {
    ...
    hero: {
      ...
      viewSpecsAndGallery: 'VER FICHA TÉCNICA & GALERÍA COMPLETA',
      vipWhatsApp: 'CONSULTA VIP POR WHATSAPP',
      dockTitle: 'EXHIBICIÓN SHOWROOM: SELECCIONA CUALQUIER VEHÍCULO',
  ...
  EN: {
    ...
    hero: {
      badge: 'VIP SHOWROOM PAVILION • 2026 FLEET',
      titleLine1: 'YOUR JOURNEY.',
      titleLine2: 'YOUR VEHICLE.',
      description: 'Explore our exclusive luxury fleet. Use the navigation arrows or dock to switch models, and click to view full specifications and gallery.',
      dailyRate: 'Daily Rate',
      perDaySuffix: '/ 24h',
      bookThisVehicle: 'RESERVE THIS VEHICLE',
      viewSpecsAndGallery: 'VIEW SPECIFICATIONS & FULL GALLERY',
      vipWhatsApp: 'VIP CONCIERGE WHATSAPP',
      dockTitle: 'SHOWROOM PAVILION: SELECT ANY VEHICLE',
